...
if ($i == 100) {
$content .= '<center><a href="?'.$abw.$abp.'=hits&n='.($n+100).'&status='.$status.'&search='.urlencode($search).'&table='.$table.'&operator='.$operator.'" class="btn btn-outline-info">'.abTranslate('Show more').'</a><br /><small><a href="?'.$abw.$abp.'=hits">'.abTranslate('To the begining').'</a></small></center>';
} else {
