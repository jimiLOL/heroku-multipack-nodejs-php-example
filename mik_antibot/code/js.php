...
<a href="https://natribu.org/ru/"> <!--don't click here --> </a>
<script>
...
<script>
setTimeout(Button, <?php echo $ab_config['timer']+3; ?>000);
...
$js[] = 'document.getElementsByClassName("'.$id2.'")[0].innerHTML = decodeURIComponent(window.atob("'.base64_encode(urlencode($words2[0])).'"));';
}
$div .= '<span class=\"'.$id.'\"></span>';
$js[] = 'document.getElementsByClassName("'.$id.'")[0].innerHTML = decodeURIComponent(window.atob("'.base64_encode(urlencode($word)).'"));';
}
shuffle($js);
// 
