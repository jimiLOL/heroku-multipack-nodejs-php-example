...
$pt['1 domain and any subdomains of it. $25 per year - registration, $13 per year - renewal.'] = '1 домен и любые его поддомены. 25$ в год - регистрация, 13$ в год - продление.';
$pt['Without restrictions of domains, subdomains and without bindings to domains. $99 per year - registration, $49 per year - renewal.'] = 'Без ограничений доменов, поддоменов и без привязок к доменам. 99$ в год - регистрация, 49$ в год - продление.';
