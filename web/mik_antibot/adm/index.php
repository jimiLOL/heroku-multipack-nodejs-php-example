...
<p>'.abTranslate('Database file size').' /antibot/data/sqlite.db: '.$size.' bytes.</p>';
...
<strong>ONE:</strong> '.abTranslate('1 domain and any subdomains of it. $25 per year - registration, $13 per year - renewal.').'<br />
<strong>UNLIMITED:</strong> '.abTranslate('Without restrictions of domains, subdomains and without bindings to domains. $99 per year - registration, $49 per year - renewal.').'<br />
